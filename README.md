...
- Four difficulty levels<br><br>
  <img src='gifs/difficulty.gif' width=500px height=377px style="height:auto;">
  
- Four languages<br><br>
  <img src='gifs/languages.gif' width=500px height=377px style="height:auto;">

- Pausing/Unpausing<br><br>
  <img src='gifs/pausing.gif' width=500px height=377px style="height:auto;">

- Notes mode<br><br>
  <img src='gifs/notes.gif' width=500px height=377px style="height:auto;">

- Saving and resetting game statistics (best time, average time and games count on every difficulty)<br><br>
  <img src='gifs/stats.gif' width=500px height=377px style="height:auto;">

- Continuation after returning to the menu<br><br>
  <img src='gifs/continue.gif' width=500px height=377px style="height:auto;">

- Reverting the last move<br><br>
  <img src='gifs/undo.gif' width=500px height=377px style="height:auto;">
